...
These are the variables we are using:
  ...
  CDN: https://cdn.sso.mozilla.com/nlx/640dc17
  Features:
   autologin: true
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.sso.mozilla.com/nlx/640dc17/css/fonts.css" type="text/css" />
    <link rel="stylesheet" href="https://cdn.sso.mozilla.com/nlx/640dc17/css/styles.css" type="text/css" />
    <link rel="icon" href="https://cdn.sso.mozilla.com/nlx/640dc17/images/favicon.png" type="image/png" sizes="192x192" />
  </head>
  <body data-decorator="load-ga display-rp-name prevent-clickjack track-password-manager-usage check-keyboard">
    ...
    <div class="card">
      <a href="https://mozilla.org" class="logo" target="_blank"><img alt="Mozilla" src="https://cdn.sso.mozilla.com/nlx/640dc17/images/mozilla.svg" /></a>
      ...
      <form id="nlx-form" data-decorator="init-auth handle-submit" method="post" action="/" lock-state="initial">
        <fieldset class="hidden-lastpass-password-offset" data-decorator="decide-screen">
          ...
          <div id="loading" class="loading" data-screen hidden>
            ...
            <img src="https://cdn.sso.mozilla.com/nlx/640dc17/images/loading.svg" class="loading__spinner" alt="" />
          ...
          <div id="initial" data-screen hidden>
            ...
            <ul class="login-options list list--plain">
              <li data-optional-login-method="firefoxaccounts">
                <button class="button button--full-width button--social button--secondary" type="button" data-handler="authorise-firefoxaccounts">
                  <img class="icon" src="https://cdn.sso.mozilla.com/nlx/640dc17/images/firefox.svg" alt="">
              ...
              <li data-optional-login-method="github">
                <button class="button button--github button--full-width button--social button--secondary" type="button" data-handler="authorise-github">
                  <img class="icon icon-default" src="https://cdn.sso.mozilla.com/nlx/640dc17/images/github.svg" alt="">
                  <img class="icon icon-hover" src="https://cdn.sso.mozilla.com/nlx/640dc17/images/github-white.svg" alt="">
              ...
              <li data-optional-login-method="google-oauth2">
                <button class="button button--full-width button--social button--secondary" type="button" data-handler="authorise-google">
                  <img class="icon" src="https://cdn.sso.mozilla.com/nlx/640dc17/images/google.svg" alt="">
            ...
            <div data-decorator="hide-autologin-setting-conditionally">
              <hr>
              <div class="setting">
                <a href="#what-is-autologin" class="link-to-tooltip" data-decorator="tooltip"><span class="visually-hidden">What is Auto-login?</span> <img class="icon" src="https://cdn.sso.mozilla.com/nlx/640dc17/images/info.svg" alt=""></a>
          ...
          <div id="initial-login-signup" data-screen hidden>
            ...
            <div data-decorator="hide-autologin-setting-conditionally">
              <hr>
              <div class="setting">
                <a href="#what-is-autologin-2" class="link-to-tooltip" data-decorator="tooltip"><span class="visually-hidden">What is Auto-login?</span> <img class="icon" src="https://cdn.sso.mozilla.com/nlx/640dc17/images/info.svg" alt=""></a>
          ...
          <div id="passwordless-success" data-screen hidden>
            <h2 class="card__heading card__heading--success"><img src="https://cdn.sso.mozilla.com/nlx/640dc17/images/envelope.svg" class="card__heading-icon" alt="" /> <span>Success</span></h2>
          ...
          <div id="error-password" data-screen hidden>
            <h2 class="card__heading card__heading--error" id="error-message-ldap"><img src="https://cdn.sso.mozilla.com/nlx/640dc17/images/circled-x.svg" class="card__heading-icon" alt="" /> <span>Error</span></h2>
          ...
          <div id="error-passwordless" data-screen hidden>
            <h2 class="card__heading card__heading--error" id="error-message-passwordless"><img src="https://cdn.sso.mozilla.com/nlx/640dc17/images/circled-x.svg" class="card__heading-icon" alt="" /> <span>Error</span></h2>
          ...
          <div id="ldap-not-available" data-screen hidden>
            <h2 class="card__heading card__heading--error"><img src="https://cdn.sso.mozilla.com/nlx/640dc17/images/circled-x.svg" class="card__heading-icon" alt="" /> <span>Error</span></h2>
    ...
    {
      "hostedConfig": "",
      "environment": "PROD",
    ...
    <script src="https://cdn.sso.mozilla.com/nlx/640dc17/js/main.js"></script>
  </body>
</html>
